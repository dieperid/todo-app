<div id="search-box" class="flex flex-col items-center px-2 my-4 justify-center">
    <div class="flex justify-center items-center">
        ...
        <!--
            "wire:model.live" is to make the search in live mode without having to have an event click
            and the "debounce.500ms" is to only send search request every 500ms
        -->
